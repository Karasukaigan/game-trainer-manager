...
class MainWindow(QMainWindow):
    ...
    def initUI(self):
        ...
        updateAction = fileMenu.addAction(self.tr("更新trainers_list.csv"))
        openListAction = fileMenu.addAction(self.tr("打开trainers_list.csv"))
        openOldListAction = fileMenu.addAction(self.tr("打开trainers_list_old.csv"))
